...
public class LocationController {
	...
	public double findLocation(String dc1Name, String dc2Name) throws Exception {
		...
		String latLongs1[] = getLatLongPositions(region1.getLocation());

		// in form latitude and longitude
		String latLongs2[] = getLatLongPositions(region2.getLocation());

		// find distance in kms between two places using coordinates
		retDistance = computeLatLong(Double.parseDouble(latLongs1[0]), Double.parseDouble(latLongs1[1]),
				Double.parseDouble(latLongs2[0]), Double.parseDouble(latLongs2[1]));
		return retDistance;
	}
